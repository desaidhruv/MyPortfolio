fetch("https://api.github.com/users/desaidhruv/repos")
    ...
    .then((data) => {
        ...
        document.getElementById("card-text3").innerHTML = `${data[17].description}`
        ...
        document.getElementById("card-link3").innerHTML = `
            <a href="${data[17].html_url}" class="btn">View</a>
        `
        ...
        document.getElementById("card-text4").innerHTML = `${data[21].description}`
        ...
        document.getElementById("card-text5").innerHTML = `${data[19].description}`
